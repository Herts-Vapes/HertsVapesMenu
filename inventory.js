...
window.HV_INVENTORY = {
  ...
  salts: {
    title: "Nic Salts",
    items: [
      { name: "Elux Legend Nic Salts", price: "£2.50", meta: "20mg • 24 flavours available", popular: true, flavours: ["Mr Blue", "Blueberry Cranberry Cherry", "Blue Razz Gummy", "Blackberry Ice", "Banana Ice", "Fizzy Cherry", "Watermelon Ice", "Blueberry Sour Raspberry", "Strawberry Ice", "Cherry Ice", "Blue Razz Cherry", "Cherry Sour Raspberry", "Grape", "Lemon Lime", "Strawberry Raspberry Cherry", "Cherry Lime", "Pineapple Ice", "Lemonade", "Triple Mango", "Raspberry Watermelon", "Oasis", "Black Cherry", "Triple Melon", "Strawberry Ice Cream"] }
    ]
  },
